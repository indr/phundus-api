namespace Phundus.Specs.Rest
{
    ...
    public class when_orders_post_is_issued : concern
    {
        ...
        public Because of = () => { response = api.PostOrder(organizationId, new Guid("7F756549-2C27-464B-BA27-B8EFD02175FD")); };
    ...
    public abstract class organizations_orders_patch_concern : concern
    {
        ...
        public Establish ctx = () => { orderId = api.PostOrder(organizationId, new Guid("7F756549-2C27-464B-BA27-B8EFD02175FD")).Data.OrderId; };
    }
    ...
    public class when_orders_items_post_is_issued : concern
    {
        ...
        public Establish c = () => { orderId = api.PostOrder(organizationId, new Guid("7F756549-2C27-464B-BA27-B8EFD02175FD")).Data.OrderId; };
    ...
    public class when_orders_items_patch_is_issued : concern
    {
        ...
        public Establish c = () =>
        {
            orderId = api.PostOrder(organizationId, new Guid("7F756549-2C27-464B-BA27-B8EFD02175FD")).Data.OrderId;
