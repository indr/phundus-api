namespace Phundus.Common.Events
{
    ...
    public abstract class StoredEventBase
    {
        ...
        protected StoredEventBase(Guid eventGuid, DateTime occuredOnUtc, string typeName, byte[] serialization)
        {
        ...
        public StoredEventBase(Guid eventGuid, DateTime occuredOnUtc, string typeName, byte[] serialization,
