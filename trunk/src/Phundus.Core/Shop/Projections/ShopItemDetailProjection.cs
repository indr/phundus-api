namespace Phundus.Shop.Projections
{
    ...
    public class ShopItemDetailProjection : ProjectionBase<ShopItemDetailData>, IStoredEventsConsumer
    {
        ...
        public void Process(ArticleCreated domainEvent)
        {
            ...
            var row = new ShopItemDetailData();
        ...
        private ShopItemDetailData GetRow(Guid articleGuid)
        {
            Session.Flush();
    ...
    public class ShopItemDetailData
    {
