namespace Phundus.Tests.Inventory.Events
{
    ...
    public class article_created : domain_event_concern<ArticleCreated>
    {
        ...
        private It should_have_the_member_price_at_8 = () =>
            dataMember(8).ShouldEqual(theMemberPrice);

        private It should_have_the_public_price_at_9 = () =>
            dataMember(9).ShouldEqual(thePublicPrice);
    }
}