namespace Phundus.Rest.Api.Organizations
{
    ...
    //    [GET("{contractId}")]
    //    [Transaction]
    //    public virtual HttpResponseMessage Get(Guid organizationId, int contractId)
    //    {
    ...
    //    [POST("")]
    //    [Transaction]
    //    public virtual HttpResponseMessage Post(Guid organizationId, ContractsPostDoc doc)
    //    {
