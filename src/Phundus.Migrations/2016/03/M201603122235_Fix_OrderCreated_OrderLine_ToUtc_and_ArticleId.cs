namespace Phundus.Migrations
{
    ...
    [Migration(201603122235)]
    public class M201603122235_Fix_OrderCreated_OrderLine_ToUtc_and_ArticleId : EventMigrationBase
    {
        protected override void Migrate()
        {            
            var events = FindStoredEvents<OrderCreated>("Phundus.Shop.Orders.Model.OrderCreated, Phundus.Core")
